      ...
      <section className="mt-8">
        ...
        {/* <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {bookings.flightBookings.length > 0 ? (
            bookings.flightBookings.map((flight) => (
              <div
                key={flight.
                  flight}
                className="bg-white p-4 shadow-md rounded-lg hover:shadow-lg"
              >
                <h3 className="text-lg font-medium">{flight.flightName}</h3>
          ...
          {bookings.carBookings.length > 0 ? (
            bookings.carBookings.map((car) => (
              <div
                ...
                className="bg-white p-4 shadow-md rounded-lg hover:shadow-lg"
              >
                <h3 className="text-lg font-medium">{car.carName}</h3>
                <p>Pickup: {car.
pickupAddress}</p>
                <p>Drop-off: {car.dropAddress}</p>
              </div>
            ))
          ) : (
