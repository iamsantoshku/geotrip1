...
//       {carBookings.map((car) => (
//         <div key={car._id} className="card border mb-4">
//           <div className="card-header p-4 border-b flex justify-between">
//             <div>
//               <h6 className="text-lg font-bold">{car.carName}</h6>
//               <p className="text-sm text-muted">Booking ID: {car._id}</p>
//             </div>
//             <div>
...
//             <p>Pickup: {car.pickupAddress}</p>
//             <p>Drop: {car.dropAddress}</p>
//             <p>Price: {car.price}</p>
//           </div>
//         </div>
//       ))}
...
//         {carBookings.map((car) => (
//           <div key={car._id} className={`card border br-dashed mb-4 ${car.bookingStatus === "cancelled" ? "bg-light text-muted" : ""}`}>
//             {/* Card header */}
...
//                 ) : (
//                   <a href="#" className="btn btn-md btn-light-seegreen fw-medium mb-0">
//                     Manage Booking
//                   </a>
//                 )}
//               </div>
