...
//             {/* Filter Sidebar */}
//             <div className='w-1/4 p-4 bg-white shadow-md mt-8 rounded-sm'>
...
//                             <div className='grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-3 lg:px-8'>
...
//             <button className='md:hidden p-3 bg-blue-600 text-white rounded-lg m-4 flex items-center' onClick={() => setIsSidebarOpen(true)}>
//                 <FaFilter className='mr-2' /> Filters
//             </button>

//             {/* Sidebar */}
//             <div className={`fixed md:static top-0 left-0 w-2/4 lg:ml-6 mt-5 rounded-md md:w-1/5 h-full bg-white shadow-lg p-4 transition-transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}> 
...
//                             </div>
//                         ) : (
//                             <p className='text-center text-gray-600'>No rentals found in {city}</p>
//                         )}
//                     </div>
//                 )}
//             </div>
