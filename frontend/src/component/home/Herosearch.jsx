...
const HeroSearch = () => {
  ...
  return (
    <div className="search-explore-wrap lg:px-10 bg-gray-100">
      <div className="container ">
        <div className="row ">
          <div className="col-xl-12 col-lg-12 col-md-12">
            <div className="search-wrap with-label overio">
...
//                             onClick={() => setActiveTab('hotels')}
//                             style={{
//                               backgroundColor: activeTab === 'hotels' ? 'white' : 'transparent',
//                               color: activeTab === 'hotels' ? 'rgb(0, 49, 73)' : 'white',
//                             }}
//                           >
//                             <i className="fa-solid fa-hotel me-2"></i>Hotels
//                           </button>
...
//                             onClick={() => setActiveTab('flights')}
//                             style={{
//                               backgroundColor: activeTab === 'flights' ? 'white' : 'transparent',
//                               color: activeTab === 'flights' ? 'rgb(0, 49, 73)' : 'white',
//                             }}
//                           >
//                             <i className="fa-solid fa-jet-fighter me-2"></i>Flights
//                           </button>
...
//                             onClick={() => setActiveTab('tours')}
//                             style={{
//                               backgroundColor: activeTab === 'tours' ? 'white' : 'transparent',
//                               color: activeTab === 'tours' ? 'rgb(0, 49, 73)' : 'white',
//                             }}
//                           >
//                             <i className="fa-solid fa-globe me-2"></i>Tour
//                           </button>
...
//                             onClick={() => setActiveTab('cabs')}
//                             style={{
//                               backgroundColor: activeTab === 'cabs' ? 'white' : 'transparent',
//                               color: activeTab === 'cabs' ? 'rgb(0, 49, 73)' : 'white',
//                             }}
//                           >
//                             <i className="fa-solid fa-car me-2"></i>Cab
//                           </button>
