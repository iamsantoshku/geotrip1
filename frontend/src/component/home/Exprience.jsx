          ...
          <div className="row align-items-center justify-content-between">
            ...
            <div className="col-xl-5 col-lg-6 col-md-6">
              <div className="bestExperience-block">
                ...
                <p className="fw-light fs-6">{description}</p>
