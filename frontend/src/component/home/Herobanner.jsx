    ...
    <div id="myCarousel" className="carousel slide carousel-fade mb-6">
      <div className="carousel-inner">
        {banners.map((banner, index) => (
          <div
            key={banner.id}
            className={`carousel-item ${index === 0 ? 'active' : ''} bg-cover`}
...
//                 plan a trip, and explore beautiful destinations.
//               </p>
//               <p className="mt-5">
//                 <a className="btn btn-primary px-5" href="#">
//                   Explore More
...
//               <h1>
//                 Explore The World{" "}
//                 <span className="position-relative z-4">Around</span>
//               </h1>
//               {/* Add similar content as needed */}
//             </div>
//           </div>
//         </div>
//       </div>
