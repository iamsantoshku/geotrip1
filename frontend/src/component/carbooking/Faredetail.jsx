...
//               </div>
//               <div className="mb-3">
//                 {/* <p className="text-dark fw-bold mb-0">dfd</p> */}
//                 <p>{car.name}</p>
...
//                 <input type="text" className="form-control mb-2" defaultValue="1674 Oak Drive Albany, New York" />
//                 <label className="form-label">Drop Address</label>
//                 <input type="text" className="form-control mb-4" defaultValue="1735 Sycamore Dallas, San Jose" />
//               </div>
//               <button className="btn btn-primary w-100">Proceed For Booking</button>
//             </div>
//           </div>
//     </>
...
//   const [pickupAddress, setPickupAddress] = useState('1674 Oak Drive Albany, New York');
//   const [dropAddress, setDropAddress] = useState('1735 Sycamore Dallas, San Jose');
