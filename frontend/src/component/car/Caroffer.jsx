                  ...
                  <div className="offers-container d-flex align-items-center justify-content-start p-2">
                    <div className="offers-flex position-relative">
                      ...
                      <div className="offers-pic">
                        <img src="src/assets/img/city/ct-6.png" className="img-fluid rounded" width="110" alt="Los Angeles" />
                      </div>
                    </div>
                ...
                <a href="#" className="card rounded-3  br-dashed border-2 m-0">
                  <div className="offers-container d-flex align-items-center justify-content-start p-2">
                    <div className="offers-flex position-relative">
                      ...
                      <div className="offers-pic">
                        <img src="src/assets/img/city/ct-5.png" className="img-fluid rounded" width="110" alt="United Kingdom" />
                      </div>
                    </div>
                    <div className="offers-captions ps-3">
                      <h4 className="city fs-6 m-0 fw-bold">
                ...
                <a href="#" className="card rounded-3  br-dashed border-2 m-0">
                  <div className="offers-container d-flex align-items-center justify-content-start p-2">
                    <div className="offers-flex position-relative">
                      ...
                      <div className="offers-pic">
                        <img src="src/assets/img/city/ct-1.png" className="img-fluid rounded" width="110" alt="France" />
                      </div>
                    </div>
                    <div className="offers-captions ps-3">
                      <h4 className="city fs-6 m-0 fw-bold">
