...
//               <img src="assets/img/logo-light.png" className="logo" alt="Logo Light" />
//             </a>
...
//               {/* Currency Dropdown */}
//               {/* <li className="currencyDropdown me-2">
//         <a href="#" className="nav-link" data-bs-toggle="modal" data-bs-target="#currencyModal">
//           <span className="fw-medium">INR</span>
//         </a>
//       </li> */}
    ...
    <div className={`header theme ${isHomePage ? 'header-transparent' : 'bg-gray-300'} lg:px-10`}>
      <div className="container">
        <nav id="navigation" className="navigation navigation-landscape">
          <div className="nav-header">
            {/* <a className="nav-brand static-show" href="/">
              <img src="assets/img/logo.png" className="logo" alt="Logo Light" />
            </a> */}
