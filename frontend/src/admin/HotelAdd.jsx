...
//     e.preventDefault();
//     try {
//       const response = await axios.post('http://localhost:4040/api/v1/hotels/hotel', hotelData); // Replace with your API URL
...
//     discount: '',
//     reviews: '',
//     cancellationPolicy: '', // For freeCancellation mapping
//     amenities: [],
//     thumbnail: '', // Added for image upload
//   });
...
//     try {
//       const response = await axios.post(`${BACKENDURL}/api/v1/hotels/hotel`, updatedHotelData); // Replace with your API URL
//       setSuccessMessage('Hotel added successfully!');
//       setErrorMessage('');
//       setHotelData({
//         name: '',
...
//             id="thumbnail"
//             name="thumbnail"
//             onChange={(e) => setHotelData({ ...hotelData, thumbnail: e.target.files[0] })}
//             required
//           />
//         </div>
