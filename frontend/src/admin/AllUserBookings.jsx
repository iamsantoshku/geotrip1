...
//       try {
//         const response = await axios.get(BACKENDURL + "api/v1/auth/all-user-bookings"); // Adjust the URL as needed
//         setUserBookings(response.data.users);
//         setLoading(false);
//       } catch (err) {
...
//       <h1 className="text-3xl font-bold text-center mb-6">All User Bookings</h1>
...
//               {/* Hotel Bookings */}
//               {user.hotelBookings.length > 0 && (
//                 <div className="mb-4">
//                   <h3 className="text-lg font-semibold">Hotel Bookings:</h3>
//                   <ul className="list-disc pl-6 text-gray-700">
//                     {user.hotelBookings.map((booking, idx) => (
//                       <li key={idx}>
...
//               {/* Flight Bookings */}
//               {user.flightBookings.length > 0 && (
//                 <div className="mb-4">
//                   <h3 className="text-lg font-semibold">Flight Bookings:</h3>
//                   <ul className="list-disc pl-6 text-gray-700">
//                     {user.flightBookings.map((booking, idx) => (
//                       <li key={idx}>
//                         {booking.name} - {booking.date}
//                       </li>
//                     ))}
...
//               {/* Car Bookings */}
//               {user.carBookings.length > 0 && (
//                 <div>
//                   <h3 className="text-lg font-semibold">Car Bookings:</h3>
//                   <ul className="list-disc pl-6 text-gray-700">
//                     {user.carBookings.map((booking, idx) => (
//                       <li key={idx}>
//                         {booking.name} - {booking.date}
//                       </li>
//                     ))}
...
//           `${BACKENDURL}api/v1/auth/all-user-bookings`
//         ); // Adjust the URL as needed
//         setUserBookings(response.data.users || []); // Default to empty array if no users
//         setLoading(false);
//       } catch (err) {
//         setError(err.response?.data?.message || "Something went wrong");
//         setLoading(false);
...
//           {userBookings.map((user, index) => (
//             <div
//               key={user.user?.id || index} // Fallback to index if id is missing
//               className="bg-white shadow-md rounded-lg p-4 border border-gray-200"
//             >
//               <h2 className="text-xl font-semibold mb-2">{user.user?.name}</h2>
//               <p className="text-gray-600 mb-4">{user.user?.email}</p>
...
//                             <li key={booking._id}>{JSON.stringify(booking)}</li>
//                         ))}
//                     </ul>
